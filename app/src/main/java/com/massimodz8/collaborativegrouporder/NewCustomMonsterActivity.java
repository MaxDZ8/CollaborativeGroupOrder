...
public class NewCustomMonsterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ChallangeRatioAdapter((Spinner) findViewById(R.id.ncma_cr), 20, getLayoutInflater());
        new TwinArraySpinnerAdapter((Spinner) findViewById(R.id.ncma_size), this, new int[] {
                MonsterData.FINE,
            ...
            getString(R.string.mobs_size_colossal)
        });
        new TwinArraySpinnerAdapter((Spinner) findViewById(R.id.ncma_type), this, new int[] {
                ...
                getString(R.string.mobs_type_vermin)
        });
        new TwinArraySpinnerAdapter((Spinner) findViewById(R.id.ncma_race), this, new int[] {
            MonsterData.DWARF,
            MonsterData.ELF,
            MonsterData.GNOME,
            ...
            MonsterData.REPTOID
                ...
                getString(R.string.mobs_race_reptoid)
        });
    }
