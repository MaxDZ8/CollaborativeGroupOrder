...
public class PartyJoinOrderService extends PublishAcceptService {
    ...
    /* Section 3: identifying joining devices and binding characters. ------------------------------
                ...
                */
    public void initializePartyManagement(@NonNull StartData.PartyOwnerData.Group party, Session.Suspended live, @NonNull JoinVerificator keyMaster, MonsterData.MonsterBook monsterBook, MonsterData.MonsterBook customMobs) {
        ...
        session = new SessionHelper(live, byDef, monsterBook, customMobs) {
            @Override
            void onRollReceived() {
